...
public sealed class AudD : IDisposable, IAsyncDisposable
{
    ...
    public async Task<RecognitionResult?> RecognizeAsync(
        ...
        IEnumerable<string>? @return = null,
        string? market = null,
        TimeSpan? timeout = null,
        CancellationToken cancellationToken = default)
        => await RecognizeAsync(RecognitionSource.From(sourceUrlOrPath), @return, market, timeout, cancellationToken).ConfigureAwait(false);

    /// <inheritdoc cref="RecognizeAsync(string, IEnumerable{string}?, string?, TimeSpan?, CancellationToken)"/>
    public Task<RecognitionResult?> RecognizeAsync(
        ...
        TimeSpan? timeout = null,
        CancellationToken cancellationToken = default)
        => RecognizeAsync(RecognitionSource.From(file), @return, market, timeout, cancellationToken);
    ...
    public Task<RecognitionResult?> RecognizeAsync(
        ...
        TimeSpan? timeout = null,
        CancellationToken cancellationToken = default)
        => RecognizeAsync(RecognitionSource.From(bytes), @return, market, timeout, cancellationToken);
    ...
    public Task<RecognitionResult?> RecognizeAsync(
        ...
        TimeSpan? timeout = null,
        CancellationToken cancellationToken = default)
        => RecognizeAsync(RecognitionSource.From(stream), @return, market, timeout, cancellationToken);

    private async Task<RecognitionResult?> RecognizeAsync(
        RecognitionSource source,
        IEnumerable<string>? @return,
        string? market,
        TimeSpan? timeout,
    ...
    public Task<IReadOnlyList<EnterpriseMatch>> RecognizeEnterpriseAsync(
        ...
        => RecognizeEnterpriseAsync(RecognitionSource.From(sourceUrlOrPath),
            @return, skip, every, limit, skipFirstSeconds, useTimecode, accurateOffsets,
            timeout, cancellationToken);

    /// <inheritdoc cref="RecognizeEnterpriseAsync(string, IEnumerable{string}?, int?, int?, int?, int?, bool?, bool?, TimeSpan?, CancellationToken)"/>
    public Task<IReadOnlyList<EnterpriseMatch>> RecognizeEnterpriseAsync(
        FileInfo file,
        IEnumerable<string>? @return = null,
        int? skip = null,
