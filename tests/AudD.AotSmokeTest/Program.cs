...
// 2. Source-generated parse path — exercises AudDJsonContext.Default.StreamCallbackResult.
...
""";
var payload = AudDHelpers.ParseCallback(body);
Console.WriteLine($"is_result={payload.IsResult} radio_id={payload.Result?.RadioId} hits={payload.Result?.Results.Count}");
